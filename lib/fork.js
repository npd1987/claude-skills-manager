 ...
 * is compiled or bundled — the published package *is* the source.
 */
 ...
 *     giveBack   — hand the name back; `keepShortcut` decides whether this copy
 ...
 *     rename     — call this copy something else
 *     takeover   — make this copy the main one, taking the original's name
 *
