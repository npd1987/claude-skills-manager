...
function assertInstallable(dir) {
  ...
  throw new Error(
    ...
    '  every update — a shortcut to it would stop working. Install it properly first:\n\n' +
 ...
 * tools — three files is the whole thing.
 */
...
`
  ...
  // A GUI launch on macOS gets a minimal PATH that often lacks node — anything
  // installed by nvm or Homebrew is invisible — so bake in the interpreter that
...
/** Which of them are actually there — what Manage reports on. */
