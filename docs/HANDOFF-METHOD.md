...
| **CLAUDE.md baseline** | **196 lines on 2026-09-10**, moved up by one from 195 for `lib/prefs.js` in the file list, which is the kind of line that earns its place. It must not trend upwards otherwise; a line in costs a line out |
